...
return Factory.new({
	...
	Tabs={
		...
		{Id="Club",Label="CLUB CUSTOM",Description="Identity and presentation",Cards={{Title="HOME KIT",Subtitle="HOME KIT",Meta="EQUIPPED",Action={Label="CHANGE KIT",Operation="Select",Key="ClubKit",Item="HOME KIT"}},{Title="CREST",Subtitle="ELECTRIC V",Meta="LEVEL 4",Action={Label="CUSTOMIZE",Operation="ComingSoon",Message="Crest editor placeholder opened."}},{Title="STADIUM THEME",Subtitle="AFTERDARK",Meta="OWNED",Action={Label="EQUIP THEME",Operation="Select",Key="StadiumTheme",Item="Afterdark"}}}},
		{Id="Customize",Label="CUSTOMIZE",Description="Equip, unequip and preview owned Store cosmetics.",Cards={}},
