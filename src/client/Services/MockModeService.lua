			...
			for index,id in order do
				...
				if bundle then
					table.insert(coinsTab.Cards,{
						...
						Accent=index==#order,
						Action={Label="BUY COINS",Operation="RobuxCoins",ServerAction="BuyCoins",ServerId=id,Confirm=true,Description="This grants coins through the server receipt flow."},
					})
				end
			end
		end
