...
function Builder.open(parent:Instance,context:any)
	...
	accent.ZIndex=72
	accent.Parent=top
	label(top,"PRO CLUBS",UDim2.fromOffset(28,12),UDim2.fromOffset(220,18),9,Theme.Colors.Electric,Theme.Fonts.Strong)
	...
	content.ScrollBarImageColor3=Theme.Colors.Electric
	...
	render=function(pro:any)
		...
		if not pro or pro.Created~=true then
			...
			label(empty,"STARTING OVR 60  •  20 ATTRIBUTE POINTS  •  LEVEL CAP 100",UDim2.fromOffset(24,122),UDim2.new(1,-48,0,24),10,Theme.Colors.Electric,Theme.Fonts.Strong)
		...
		label(summary,"BUILD: "..((pro.BuildPath~=""and pro.BuildPath)or"UNSELECTED"),UDim2.fromOffset(24,82),UDim2.new(1,-270,0,22),10,Theme.Colors.Electric,Theme.Fonts.Strong)
		local overall=label(summary,tostring(pro.Overall or 60),UDim2.new(1,-228,0,16),UDim2.fromOffset(88,58),43,Theme.Colors.Electric,Theme.Fonts.Display)
		...
		for category,attributes in ProClubsConfig.Categories do
			...
			label(categoryPanel,string.upper(category),UDim2.fromOffset(20,10),UDim2.new(1,-40,0,28),15,Theme.Colors.Electric,Theme.Fonts.Display)
			for index,attribute in attributes do
				...
				local score=label(row,tostring(value),UDim2.new(1,-132,0,0),UDim2.fromOffset(46,38),14,value>=80 and Theme.Colors.Electric or Theme.Colors.White,Theme.Fonts.Display)
		...
		label(builds,"BUILD PATH",UDim2.fromOffset(20,10),UDim2.new(1,-40,0,28),15,Theme.Colors.Electric,Theme.Fonts.Display)
