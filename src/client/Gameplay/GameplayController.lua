...
function Controller:_state(payload:any)
	...
	elseif payload.Type=="ReceptionOverrideHint"then if self.HUD then self.HUD:Flash("HOLD "..ControlGlyphService.Glyph("ReceiverOverride",self.PlayabilitySettings).." TO TAKE FULL CONTROL",.75)end
