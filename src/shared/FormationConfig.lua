...
Config.Orders = {
	...
	["4-1-2-1-2"] = DEFAULT_ORDER,
	["4-5-1"] = DEFAULT_ORDER,
	["3-4-3"] = DEFAULT_ORDER,
	["4-3-2-1"] = DEFAULT_ORDER,
	["3-5-2"] = DEFAULT_ORDER,
	["5-3-2"] = DEFAULT_ORDER,
...
Config.Formations = {
	...
	["4-1-2-1-2"] = {
		...
		CM1 = slot(.31,.45,"LCM","CM","CM","LeftHalfSpace"),
		CM2 = slot(.69,.45,"RCM","CM","CM","RightHalfSpace"),
		LW = slot(.50,.32,"CAM","CAM","CAM","Center"),
		ST = slot(.39,.18,"LS","ST","ST","LeftHalfSpace"),
		RW = slot(.61,.18,"RS","ST","ST","RightHalfSpace"),
	},
	["4-5-1"] = {
		GK = slot(.50,.88,"GK","GK","GK","Center"),
		LB = slot(.18,.70,"LB","LB","Fullback","LeftWide"),
		...
		RB = slot(.82,.70,"RB","RB","Fullback","RightWide"),
		CDM = slot(.50,.56,"CDM","CDM","CDM","Center"),
		CM1 = slot(.34,.46,"LCM","CM","CM","LeftHalfSpace"),
		CM2 = slot(.66,.46,"RCM","CM","CM","RightHalfSpace"),
		LW = slot(.16,.40,"LM","LW","Winger","LeftWide"),
		ST = slot(.50,.20,"ST","ST","ST","Center"),
		RW = slot(.84,.40,"RM","RW","Winger","RightWide"),
	},
	["3-4-3"] = {
		GK = slot(.50,.88,"GK","GK","GK","Center"),
		...
		RB = slot(.84,.50,"RM","RW","Winger","RightWide"),
		CM1 = slot(.39,.50,"LCM","CM","CM","LeftHalfSpace"),
		CDM = slot(.61,.50,"RCM","CM","CM","RightHalfSpace"),
		CM2 = slot(.16,.50,"LM","LW","Winger","LeftWide"),
		LW = slot(.20,.24,"LW","LW","Winger","LeftWide"),
		ST = slot(.50,.18,"ST","ST","ST","Center"),
		RW = slot(.80,.24,"RW","RW","Winger","RightWide"),
	},
	["4-3-2-1"] = {
		GK = slot(.50,.88,"GK","GK","GK","Center"),
		LB = slot(.18,.70,"LB","LB","Fullback","LeftWide"),
		...
		CB2 = slot(.62,.70,"RCB","CB","CB","RightHalfSpace"),
		RB = slot(.82,.70,"RB","RB","Fullback","RightWide"),
		CDM = slot(.50,.55,"CDM","CDM","CDM","Center"),
		CM1 = slot(.33,.48,"LCM","CM","CM","LeftHalfSpace"),
		CM2 = slot(.67,.48,"RCM","CM","CM","RightHalfSpace"),
		LW = slot(.40,.32,"LAM","CAM","CAM","LeftHalfSpace"),
		ST = slot(.50,.18,"ST","ST","ST","Center"),
		RW = slot(.60,.32,"RAM","CAM","CAM","RightHalfSpace"),
	},
	["3-5-2"] = {
		GK = slot(.50,.88,"GK","GK","GK","Center"),
		LB = slot(.28,.70,"LCB","CB","CB","LeftHalfSpace"),
