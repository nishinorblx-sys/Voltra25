...
return table.freeze({
	Pages = table.freeze({ Home=true, UltimateTeam=true, WorldCup=true, Inventory=true, Play=true, Ranked=true, Clubs=true, Career=true, Store=true, Settings=true }),
	Tabs = table.freeze({
	...
	Settings = table.freeze({ TimedFinishing="boolean",MenuMusic="boolean",MotionEffects="boolean",PerformanceMode="boolean",InvertY="boolean",HighContrast="boolean",ReducedMotion="boolean",Crossplay="boolean",ControlPreset="string",MasterVolume="number",Graphics="string",CameraPreset="string",CameraShake="string",CameraZoomMode="string",BroadcastHeight="string",BroadcastZoom="string",CameraSpeed="string",CameraSide="string",PlayerNames="string",Trainer="string",PassReceiverAutoSwitch="string",ManualPassAutoSwitch="string",ReceiverAssist="string",Minimap="string",MinimapOrientation="string",TextScale="string",PauseKey="string",SkipKey="string",TutorialComplete="boolean",TutorialStep="number",TutorialDevice="string" }),
