...
return table.freeze({
	...
	Settings = table.freeze({ TimedFinishing="boolean",MenuMusic="boolean",MotionEffects="boolean",PerformanceMode="boolean",InvertY="boolean",HighContrast="boolean",ReducedMotion="boolean",Crossplay="boolean",ControlPreset="string",MasterVolume="number",Graphics="string",CameraPreset="string",CameraShake="string",CameraZoomMode="string",BroadcastHeight="string",BroadcastZoom="string",CameraSpeed="string",CameraSide="string",PlayerNames="string",Trainer="string",PassReceiverAutoSwitch="string",ReceiverAssist="string",Minimap="string",MinimapOrientation="string",TextScale="string",PauseKey="string",SkipKey="string",TutorialComplete="boolean",TutorialStep="number",TutorialDevice="string" }),
