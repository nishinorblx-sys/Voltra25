...
local DifficultyConfig=require(script.Parent.DifficultyConfig)
return table.freeze({
	MatchFormats=MatchFormatConfig.Names,MatchLengths=table.freeze({3,4,6,8,10}),Difficulties=DifficultyConfig.MenuNames,MatchTypes=table.freeze({"Quick Match","Friendly","Training Match","Objective Match"}),Weather=table.freeze({"Clear","Cloudy","Rain","Night"}),Times=table.freeze({"Day","Evening","Night"}),KitTypes=table.freeze({"Home","Away","Third"}),
