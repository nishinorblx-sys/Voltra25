--!strict
return table.freeze({
	MatchLengths=table.freeze({3,4,6,8,10}),Difficulties=table.freeze({"Beginner","Amateur","Semi Pro","Professional","World Class","Legendary","Ultimate"}),MatchTypes=table.freeze({"Quick Match","Friendly","Training Match","Objective Match"}),Weather=table.freeze({"Clear","Cloudy","Rain","Night"}),Times=table.freeze({"Day","Evening","Night"}),KitTypes=table.freeze({"Home","Away","Third"}),
