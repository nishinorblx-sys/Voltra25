...
local DIFFICULTIES = {
	["Kickabout"] = {DecisionMin = 0.9, DecisionMax = 1.35, Mistake = 0.36, Discipline = 0.28, PassRisk = 0.18, ShotSelect = 0.26, Press = 0.25, Stamina = 0.66},
	...
	["Sunday League"] = {DecisionMin = 0.62, DecisionMax = 0.98, Mistake = 0.23, Discipline = 0.44, PassRisk = 0.29, ShotSelect = 0.41, Press = 0.4, Stamina = 0.75},
	...
	["City Division"] = {DecisionMin = 0.48, DecisionMax = 0.78, Mistake = 0.17, Discipline = 0.56, PassRisk = 0.41, ShotSelect = 0.52, Press = 0.5, Stamina = 0.81},
	...
	["Premier Standard"] = {DecisionMin = 0.34, DecisionMax = 0.61, Mistake = 0.12, Discipline = 0.68, PassRisk = 0.54, ShotSelect = 0.64, Press = 0.62, Stamina = 0.87},
	...
	["Ultimate"] = {DecisionMin = 0.07, DecisionMax = 0.15, Mistake = 0.014, Discipline = 1, PassRisk = 0.98, ShotSelect = 0.99, Press = 0.98, Stamina = 1.08},
}
