...
function Service:Apply(info: any, assignment: any, context: any, dt: number)
	...
	model:SetAttribute("AIInstructionOffBall", assignment.OffBallInstruction or info.OffBallInstruction or model:GetAttribute("VTRAttackInstruction") or "")
	model:SetAttribute("AIInstructionDefending", assignment.DefensiveInstruction or info.DefensiveInstruction or model:GetAttribute("VTRDefensiveInstruction") or "")
	model:SetAttribute("AIInstructionEffect", assignment.InstructionEffect or "")
	model:SetAttribute("AIInstructionTarget", assignment.InstructionTarget or assignment.TargetWorld or assignment.MovementTarget)
	model:SetAttribute("AIInstructionRunAllowed", assignment.InstructionRunAllowed == true or assignment.RunApproved == true)
