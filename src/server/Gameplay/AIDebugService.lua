	...
	for _, side in ipairs({"Home", "Away"}) do
		...
		for model, assignment in pairs(assignmentsBySide[side] or {}) do
			...
			if info and info.Root then
				...
				model:SetAttribute("AIDebugTacticalSlot", assignment.TacticalSlot and assignment.TacticalSlot.Id or "")
				model:SetAttribute("AIDebugTacticalFunction", assignment.TacticalSlot and assignment.TacticalSlot.Function or "")
				model:SetAttribute("AIDebugUserReservedSlot", assignment.ReservedByUser == true)
				model:SetAttribute("AIDebugRunContract", assignment.RunContract and assignment.RunContract.Id or "")
				model:SetAttribute("AIDebugRestDefense", assignment.TacticalSlot and assignment.TacticalSlot.RestDefense == true)
				model:SetAttribute("AIDebugDefensiveDuty", assignment.DefensiveDuty or model:GetAttribute("AIDefensiveDuty") or "")
