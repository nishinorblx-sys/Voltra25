...
local EVENTS: {[string]: boolean} = {
	...
	playability_client_ready = true,
	playability_tutorial_stage_entered = true,
	playability_tutorial_stage_duration = true,
	playability_tutorial_assistance = true,
	playability_tutorial_soft_retry = true,
	playability_forced_defensive_switch = true,
	playability_defensive_switch_recommendation = true,
	playability_automatic_switch_undone = true,
	playability_receiver_switch = true,
	playability_first_touch = true,
	playability_tackle_outcome = true,
	playability_possession_contact = true,
	playability_ball_divergence = true,
	playability_mobile_charge_conflict_rejected = true,
	playability_stale_action_cancelled = true,
	playability_shot_power = true,
	playability_pass_selection = true,
	playability_client_performance = true,
	playability_lifecycle_cleanup = true,
	playability_reception_started = true,
	playability_reception_committed = true,
	playability_reception_camera_prepared = true,
	playability_reception_control_transferred = true,
	playability_reception_contact = true,
	playability_reception_completed = true,
	playability_reception_cancelled = true,
	playability_reception_retargeted = true,
	playability_reception_override = true,
	playability_first_touch_intent = true,
	playability_first_time_action = true,
	playability_pass_endpoint_corrected = true,
	playability_reception_route_conflict = true,
}
