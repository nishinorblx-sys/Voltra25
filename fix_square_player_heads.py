...
service = root / "src/server/Gameplay/BlockHeadService.lua"
...
print("created src/server/Gameplay/BlockHeadService.lua")
print("created src/server/BlockHead.server.lua")